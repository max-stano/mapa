    ...
    for y in ranage (0, vyska):
      for x in range (0, sirka):
           ...
           #     duch_x = x
            #    duch_y = y
             #   duch_found = True 
                dus =  platno.create_image (duch_x * cell_size + cell_size / 2, \
                                            duch_y * cell_size + cell_size / 2, \
                                            image = duch_data)
                #duchovia.append([x, y, dus])
                break;
               
    return duch_y, duch_x #,duchovia

######################################################
#def gulicky(platno, sirka, vyska, gulicka, mapa, cell_size)
